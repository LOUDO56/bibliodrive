<div>
    <img src="images/icon/hamburger.png" alt="hamburger icon" class="hamburger-icon">
</div>
<div class="mobile-nav">
    <div>
        <img src="images/icon/cross_mark.png" alt="cross mark icon" class="cross-mark">
    </div>
            ...
            if ($utilisateur) {
                if (password_verify($_POST["mdp"], $utilisateur->motdepasse)) { // Si ça correspond, l'utilisateur est connecté
                    ...
                    if ($utilisateur->profil == "admin")
                        $_SESSION["adminUser"] = TRUE; //Si c'est un admin, attribuer le role admin.
                }
